                    ...
                    <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-10">
                        ...
                        <div className="flex flex-col items-start lg:items-end w-full lg:w-auto">
                            <ul className="text-white flex flex-wrap justify-start lg:justify-end gap-x-6 gap-y-3 mb-8 lg:mb-14">
                                <li>
                                    <a className="hover:opacity-50" href="/#service">
                                        Xizmatlarimiz
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a className="hover:opacity-50" href="/#partners">
                                        Hamkorlarimiz
                                    </a>
                                </li>
                                <li>
                                    <a className="hover:opacity-50" href="/#about">
                                        Biz haqimizda
                                    </a>
                                </li>
                                <li>
                                    <a className="hover:opacity-50" href="/contact">
                                        Aloqa
                                    </a>
                                </li>
                            </ul>
                            ...
                            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 w-full justify-end">
                                <div className="bg-[#FFFFFF1A] py-1 -pl-1 p-1 flex items-center rounded-full backdrop-blur-[100px] w-full max-w-[176px]">
