    ...
    <header className="pt-6 pb-6 relative z-50">
      <div className="max-w-[1632px] mx-auto px-5 flex items-center justify-between">
        ...
        <div className="xl:flex hidden flex-col sm:flex-row items-start sm:items-center gap-4">
          <div className="bg-[#FFFFFF1A] p-1  flex items-center rounded-full backdrop-blur-[100px] w-full sm:max-w-44">
            {/* Facebook */}
            <Link href="#" className="group w-14 h-14 p-4 rounded-full hover:bg-white transition">
              <svg
          ...
          <Link href="tel:+998900000000" className="flex items-center gap-2 bg-[#FFFFFF1A] pl-1 py-1 rounded-full backdrop-blur-[100px] w-full sm:w-auto">

            <span className="group p-4 rounded-full hover:bg-transparent bg-white transition">
              <svg
      ...
      >
        ...
        <div className="mt-35 space-y-4">
          <div className="bg-[#FFFFFF1A] p-1 flex items-center rounded-full backdrop-blur-[100px] w-full max-w-44 ">
          ...
          <Link href="tel:+998900000000" className="flex items-center gap-2 bg-[#FFFFFF1A] pl-1 py-1 rounded-full backdrop-blur-[100px]  max-w-70">
            <span className="group p-4 rounded-full hover:bg-white transition">
              <svg
                className="w-6 h-6 text-white group-hover:text-black transition"
                fill="currentColor"
                viewBox="0 0 24 24"
            ...
            <span className="text-lg min-[375px]:text-xl leading-[100%] font-medium text-white py-5 pr-4">+998 90 000 00 00</span>
          </Link>
        </div>
      </div>
    </header>
